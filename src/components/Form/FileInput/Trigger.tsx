...
const Trigger = () => {
  ...
  return (
    ...
    >
      <div className="rounded-full border-6 border-zinc-50 bg-zinc-100 p-2 group-hover:border-violet-50 group-hover:bg-violet-100 dark:border-zinc-700 dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:group-hover:border-zinc-600">
