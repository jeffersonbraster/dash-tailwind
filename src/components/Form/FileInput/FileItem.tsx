...
const fileItem = tv({
  slots: {
    ...
    icon: 'rounded-full border-4 border-violet-100 bg-violet-200 p-2 text-violet-600 dark:border-zinc-700 dark-bg-zinc-700 dark:text-zinc-500',
    deleteButton: '',
  },
      ...
      {state === 'error' ? (
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <div className="flex w-full items-center gap-3">
            <div className="h2 flex-1 rounded-full bg-zinc-100 dark:bg-zinc-600">
              <div
